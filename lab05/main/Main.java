...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            ambiente.adicionarEntidade(new Obstaculo(1, 1, 1, TipoObstaculo.Vulcao));
